...
float Toon_Intensity = 1.5; //Should only be set somewhere from 0 to 1, out of that range will cause visual problems
float Toon_Brightness = 0.899999;
float Toon_Gradient = 4; //MMD default is 3
...
float SpecularLight_Intensity = 1.25;
float SpecularLight_Focus = 25;
...
float3 Rim_Color = float3(1,1,1); //RGB value, scale: 0-1
	...
	float Rim_Intensity = 0.2; //Set it 0 to disable rim lighting completely
	float Rim_Gradient = 2.8;
